  ...
  return (
   ...
   {!toggle &&
    <div className='bg-gray-50'>
      ...
      <Link className="flex flex-row italic justify-center rounded-md font-amita font-bold text-sky-400 text-lg tracking-widest" onClick={toggler}>Feel free to add your info here!  
